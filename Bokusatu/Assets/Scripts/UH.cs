...
public class UH : MonoBehaviour {
	...
	public float[] UHQuaternion_bff = new float[4];
	public bool updateQuaternionFlg;

	//Object: Foream angle
	public static int[] UHAngle = new int[3];
...
//				UHQuaternion_bff[0] = float.Parse (QuaData.Split (new string[]{"+"}, System.StringSplitOptions.None) [0]);
//				UHQuaternion_bff[1] = float.Parse (QuaData.Split (new string[]{"+"}, System.StringSplitOptions.None) [1]);
//				UHQuaternion_bff[2] = float.Parse (QuaData.Split (new string[]{"+"}, System.StringSplitOptions.None) [2]);
//				UHQuaternion_bff[3] = float.Parse (QuaData.Split (new string[]{"+"}, System.StringSplitOptions.None) [3]);
//
//				UHQuaternion[0] = (float)(int)(UHQuaternion_bff[0]*10);
//				UHQuaternion[1] = (float)(int)(UHQuaternion_bff[1]*10);
//				UHQuaternion[2] = (float)(int)(UHQuaternion_bff[2]*10);
//				UHQuaternion[3] = (float)(int)(UHQuaternion_bff[3]*10);
